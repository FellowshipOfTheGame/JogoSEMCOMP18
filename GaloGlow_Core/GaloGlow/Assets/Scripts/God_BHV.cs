...
public class God_BHV : MonoBehaviour
{
    ...
    public int ConvertColorSystem(int ColorInput)
    {
        if (ColorInput == -1) { return 0; }
        else if (ColorInput == 0) { return 1; }
        else if (ColorInput == 1) { return 2; }
        else if (ColorInput == 2) { return 4; }
        else if (ColorInput == 3) { return 6; }
        else if (ColorInput == 4) { return 3; }
        else if (ColorInput == 5) { return 5; }
        else if (ColorInput == 6) { return 7; }
        else { return 0; }
    }
    public int DisconvertColorSystem(int ColorInput)
    {
        if (ColorInput == 0) { return -1; }
        else if (ColorInput == 1) { return 0; }
        else if (ColorInput == 2) { return 1; }
        else if (ColorInput == 4) { return 2; }
        else if (ColorInput == 6) { return 3; }
        else if (ColorInput == 3) { return 4; }
        else if (ColorInput == 5) { return 5; }
        else if (ColorInput == 7) { return 6; }
        else { return 0; }
    }
    public int FilterColor(int Filter, int FilterInput)
    {
